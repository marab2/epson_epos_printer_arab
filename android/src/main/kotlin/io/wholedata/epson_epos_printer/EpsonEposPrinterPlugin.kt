package io.wholedata.epson_epos_printer
...
/** EpsonEposPrinterPlugin */
class EpsonEposPrinterPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "epson_epos_printer")
